            ...
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-2">
                  Build your digital presence with web and mobile applications
                  that are visually stunning, user-friendly, and developed with
                  a deep passion for modern frontend technologies.
                </p>
              </div>
